...
const FGShipmentPickingReport: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`/api/reports/fg-shipment-picking`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="space-y-4">
      <Card className="mt-5">
        <CardHeader>
          <CardTitle>FG Shipment Picking Report</CardTitle>
        </CardHeader>
        <CardContent>
...
export default FGShipmentPickingReport;
